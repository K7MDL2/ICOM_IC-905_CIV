...
#ifdef bigRamAv
	constexpr uint8_t  CIVresultBufSize = 8;
#else
...
constexpr uint8_t CIV_ADDR_905  = 0xAC; // (Default-)address of the IC905
...
// public member functions
	...
	void    setupp(bool TEENSY,bool ESP_BT,String BTname);	// if a true is passed to CIV and it's running on an ESP -> BT with id BTname will be used
																							// Note: Pls delete the BT-object in the IC705 pairing menu and perform a new
																							// pairing every time you change this name - otherwise you won't see 
																							// this change in the IC705!
...
//::::::::::::: is a specific address known to CIV ?
  ...
  main function to write data to a specific radio
	...
	*/
	...
	void pass_CAT_msg_to_RADIO(void);
