...
struct Band_Memory bandmem[BANDS] = {
    ...
    { "903",   902000000,   904000000,   903100000, USB, FILT2, DATA_OFF,    903100000, USB, FILT1, DATA_OFF,    903100000,  CW,  FILT2, DATA_OFF,    903100000, USB, BW3_2, 3200,  BAND902,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTN_OFF,  0,    0,  PREAMP_OFF,  5,  OFF,  XVTR5,   BAND10M,  60,  -10,  0x0010},
    {"1296",  1296000000,  1298000000,  1296100000, USB, FILT2, DATA_OFF,   1296074000, USB, FILT1, DATA_OFF,   1296110000,  CW,  FILT2, DATA_OFF,   1296120000, USB, BW3_2, 3200,  BAND1296, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTN_OFF,  0,    0,  PREAMP_OFF,  5,  ON,   NONE,    NONE,     54,  -10,  0x0020},
    {"2400",  2304000000,  2402000000,  2304100000, USB, FILT1, DATA_OFF,   2304100000, USB, FILT1, DATA_OFF,   2304100000,  CW,  FILT2, DATA_OFF,   2304100000, USB, BW3_2, 3200,  BAND2400, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTN_OFF,  0,    0,  PREAMP_OFF,  5,  ON,   NONE,    NONE,     70,  -10,  0x0040},
    {"3400",  3400000000,  3402000000,  3400100000, USB, FILT1, DATA_OFF,   3400100000, USB, FILT1, DATA_OFF,   3400100000,  CW,  FILT2, DATA_OFF,   3400100000, USB, BW3_2, 3200,  BAND3400, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTN_OFF,  0,    0,  PREAMP_OFF,  5,  OFF,  XVTR9,   BAND10M,  80,  -10,  0x001F},
    {"5760",  5760000000,  5925000000,  5760100000, USB, FILT1, DATA_OFF,   5912100000, USB, FILT1, DATA_OFF,   5760100000,  CW,  FILT2, DATA_OFF,   5760100000, USB, BW3_2, 3200,  BAND5760, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTN_OFF,  0,    0,  PREAMP_OFF,  5,  ON,   NONE,    NONE,     14,  -10,  0x002F},
    { "10G", 10000000000, 10500000000, 10368100000, USB, FILT1, DATA_OFF,  10368100000, USB, FILT1, DATA_OFF,  10368100000,  CW,  FILT2, DATA_OFF,  10368100000, USB, BW3_2, 3200,  BAND10G,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTN_OFF,  0,    0,  PREAMP_OFF,  5,  ON,   NONE,    NONE,     24,  -10,  0x10F1},
    { "24G", 24048000000, 24050000000, 24048200000, USB, FILT1, DATA_OFF,  24192100000, USB, FILT1, DATA_OFF,  24192100000,  CW,  FILT2, DATA_OFF,  24192100000, USB, BW3_2, 3200,  BAND24G,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTN_OFF,  0,    0,  PREAMP_OFF,  5,  OFF,  XVTR12,  BAND10M,  45,  -10,  0x00F2},
    {" 47G", 47000000000, 47002000000, 47000100000, USB, FILT1, DATA_OFF,  47000100000, USB, FILT1, DATA_OFF,  47000100000,  CW,  FILT2, DATA_OFF,  47000100000, USB, BW3_2, 3200,  BAND47G,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTN_OFF,  0,    0,  PREAMP_OFF,  5,  OFF,  XVTR13,  BAND10M,  10,  -10,  0x00FF},
    {" 76G", 76000000000, 76002000000, 76000100000, USB, FILT1, DATA_OFF,  76000100000, USB, FILT1, DATA_OFF,  76000100000,  CW,  FILT2, DATA_OFF,  76000100000, USB, BW3_2, 3200,  BAND76G,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTN_OFF,  0,    0,  PREAMP_OFF,  5,  OFF,  XVTR14,  BAND10M,  10,  -10,  0x00FF},
    {"122G",122000000000,122002000000,122000100000, USB, FILT1, DATA_OFF, 122000100000, USB, FILT1, DATA_OFF, 122000100000,  CW,  FILT2, DATA_OFF, 122000100000, USB, BW3_2, 3200,  BAND122G, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTN_OFF,  0,    0,  PREAMP_OFF,  5,  OFF,  XVTR15,  BAND10M,  10,  -10,  0x00FF},
    { "PAN",     8200000,     8300000,     8215000, USB, FILT1, DATA_OFF,      8215000, USB, FILT2, DATA_OFF,      8215000,  USB, FILT2, DATA_OFF,      8215000, LSB, BW2_8, 2800,  PAN_ADAPT,1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1, 0,  ATTN_OFF,  0,   50,  PREAMP_OFF,  5,  OFF,  NONE,    NONE,      2,  -10,  0x00FF}
};
