...
struct Band_Memory bandmem[BANDS] = {
    ...
    { "144",   144000000,   148000000,   144200000, USB,    144200000, DATA,   144200000,  CW,    144200000, DATA, BW3_2, 3200,  BAND144,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_ON,   1,    3,  PREAMP_ON,   5,  ON,   NONE,    NONE,     10,   -0,  0x0002},
    ...
    { "432",   432000000,   450000000,   432100000, USB,    432100000, DATA,   432100000,  CW,    432100000, DATA, BW3_2, 3200,  BAND432,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  5,  ON,   NONE,    NONE,     40,  -10,  0x0008},
    ...
    {"1296",  1296000000,  1298000000,  1296100000, USB,   1296074000, DATA,  1296110000,  CW,   1296120000, USB,  BW3_2, 3200,  BAND1296, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  5,  ON,   NONE,    NONE,     54,  -10,  0x0020},
    {"2304",  2304000000,  2306000000,  2304100000, USB,   2304100000, DATA,  2304100000,  CW,   2304100000, DATA, BW3_2, 3200,  BAND2304, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  5,  ON,   NONE,    NONE,     70,  -10,  0x0040},
    {"2400",  2400000000,  2402000000,  2400100000, USB,   2400100000, DATA,  2400100000,  CW,   2400100000, DATA, BW3_2, 3200,  BAND2400, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  5,  ON,   NONE,    NONE,     70,  -10,  0x0080},
    ...
    {"5760",  5760000000,  5925000000,  5760100000, USB,   5912100000, DATA,  5760100000,  CW,   5760100000, USB,  BW3_2, 3200,  BAND5760, 1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  5,  ON,   NONE,    NONE,     14,  -10,  0x002F},
    { "10G", 10368000000, 10370000000, 10368100000, USB,  10368100000, DATA, 10368100000,  CW,  10368100000, DATA, BW3_2, 3200,  BAND10G,  1, AGC_SLOW,OFF,OFF,OFF,OFF,ANT1,10,  ATTEN_OFF,  0,    0,  PREAMP_OFF,  5,  ON,   NONE,    NONE,     24,  -10,  0x10F1},
